...
public:
    ...
    enum class header_value_type : uint8_t { binary, string };
    ...
    struct key_config {
        ...
        ss::sstring protobuf_name; ///< Empty = first message in file.
    ...
    struct headers_config {
        header_value_type value_type{header_value_type::binary};
